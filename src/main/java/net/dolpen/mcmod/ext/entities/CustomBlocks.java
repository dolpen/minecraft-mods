package net.dolpen.mcmod.ext.entities;
...
public class CustomBlocks {
    ...
    public static final Block single_slot_storage = new BlockSingleSlotStorage();
    ...
    public static final ArrayList<Entry> entries = Lists.newArrayList(
            new Entry("single_slot_storage", single_slot_storage)
    );
